...
class CDMSRAGSearch:
    ...
    def search(
        ...
        try:
            ...
            search_limit = limit * 2 if product_name else limit
            ...
            if product_name:
                ...
                for result in results:
                    ...
                    # Simple matching: check if product name appears in filename
                    if product_lower in source_file or product_lower in document_name:
